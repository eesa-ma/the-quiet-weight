...
const BridgeOrWall = ({ scene, onComplete }) => {
    ...
    if (isFinished) {
        ...
        return (
            <div className="relative w-full h-screen overflow-y-auto flex flex-col items-center justify-start p-4 md:p-6">
                ...
                >
                    <p className="text-sky-400 text-xs font-semibold uppercase tracking-widest">
                        {scene.title}
                    </p>
                    ...
                    <motion.button
                        ...
                        className="mt-4 px-8 py-3 rounded-xl bg-sky-600 hover:bg-sky-500 text-white text-sm font-medium transition-all cursor-pointer"
                    >
                        continue →
                    </motion.button>
                </motion.div>
