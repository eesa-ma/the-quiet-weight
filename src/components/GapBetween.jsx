...
const GapBetween = ({ scene, onComplete }) => {
    ...
    const colorMap = {
        ...
        blue:    { button: "bg-blue-500/20 border-blue-500/30 text-blue-300 hover:bg-blue-500/30",       correct: "bg-blue-500/10 border-blue-500/30",     label: "text-blue-400"    },
    ...
    const getFeedbackMessage = (score) => {
        ...
        if (percentage >= 80) return "Exceptional clarity. You understand the gap between holding on and moving forward.";
        if (percentage >= 50) return "Thoughtful awareness. Midlife transitions are rarely obvious from the inside.";
        return "The gap is subtle. Understanding it takes time — and that's the point.";
    };
        ...
        <div className="relative w-full h-screen overflow-y-auto flex flex-col items-center justify-start p-4 md:p-6">
            ...
            <motion.div
                ...
                animate={isCorrect === null ? { opacity: 0 } :
                    isCorrect ? { opacity: [0, 0.12, 0] } : { opacity: [0, 0.12, 0] }
                }
            ...
            <AnimatePresence mode="wait">
                <motion.div
                    ...
                    exit={{ opacity: 0, x: -40 }}
                    transition={{ duration: 0.4 }}
                    className="relative z-20 w-full max-w-md my-auto flex flex-col gap-4 md:gap-5"
                >
                    {/* Header */}
                    ...
                    <div className={`rounded-2xl border p-5 transition-colors duration-300
                        ${selectedCategory === null
                            ...
                            : isCorrect
                                ? `${colorMap[correctCategory?.color]?.correct} border-opacity-30`
